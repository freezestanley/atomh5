...
const WHO: FC<PropTypes> = function (props) {
  ...
  return <div className={styles['WHO']}>
    <div className={styles['WHO_banner']}>
      Who we are
    </div>
    <div className={styles['WHO_article']}>
      <p>Atom 8 Limited provides end-to-end Security Token Offering (STO) solutions to empower issuers to raise capital in a more efficient manner. It operates as a blockchain-based workflow orchestration platform servicing business clients, including sponsors (Hong Kong SFC RA6), issuers and digital custodians.</p>
      <p>Atom 8 Limited is an affiliate company to Hong Kong Digital Asset Ex Ltd. (HKbitEX), which operates the website www.hkbitex.com.hk offering custody and transaction of digital assets (cryptocurrencies and security tokens). HKbitEX is an applicant to SFC Type 1 & 7 licenses. </p></div>
